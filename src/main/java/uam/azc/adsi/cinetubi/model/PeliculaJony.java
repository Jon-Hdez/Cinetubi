...
public class PeliculaJony {
    ...
    public PeliculaJony(int idPelicula, String titulo, int duracion, String distribuidor, String clasificacion, String director, String pais, String descripcion, String genero) {
